...
public class Info extends Activity implements Receiver.EventListener {
    ...
    protected int MAX_TABLE_ENTRIES = 15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] textViewIds = new int[]{R.id.text_machine, R.id.text_project, R.id.text_build, R.id.text_fat,
                ...
                R.id.text_cid, R.id.text_lanip, R.id.text_clang, R.id.text_robspeed, R.id.text_override, R.id.text_dutytime, R.id.text_payload};
        ...
        int[] tableRowIds = new int[]{R.id.tableRow1, R.id.tableRow2, R.id.tableRow3, R.id.tableRow4,
                ...
                R.id.tableRow9, R.id.tableRow10, R.id.tableRow11, R.id.tableRow12, R.id.tableRow13, R.id.tableRow14, R.id.tableRow15};
